...
def detail(news_id):
    ...
    return render_template("detail.html", news=news, nick_name=nick_name, news_author=news_author, click_detail_news_sex=click_detail_news_sex, comments=comments, like_comment=like_comment)
